...
class Qtran_base(nn.Module):
    def __init__(self, args):
        ...
        ae_input = args.rnn_hidden_dim + args.n_actions
        ...
        q_input_size = args.state_shape + args.n_actions + args.rnn_hidden_dim
        self.Q = nn.Sequential(nn.Linear(q_input_size, args.qtran_hidden_dim),
                               nn.ReLU(),
                               nn.Linear(args.qtran_hidden_dim, args.qtran_hidden_dim),
                               nn.ReLU(),
                               nn.Linear(args.qtran_hidden_dim, 1))
...
class QtranV(nn.Module):
    def __init__(self, args):
        ...
        hidden_input = args.rnn_hidden_dim
        ...
        v_input_size = args.state_shape + args.rnn_hidden_dim
        self.V = nn.Sequential(nn.Linear(v_input_size, args.qtran_hidden_dim),
                               nn.ReLU(),
                               nn.Linear(args.qtran_hidden_dim, args.qtran_hidden_dim),
                               nn.ReLU(),
                               nn.Linear(args.qtran_hidden_dim, 1))
